...
def setup_ollama_model(complete_instruction= None,
                                        base_url="http://127.0.0.1:11434",
                                        model="llama3.1",):
    """Set up the Ollama LLM model instance."""
    if complete_instruction == None:
...
def setup_embeddings(use_nvidia=False):
    ...
    if use_nvidia:
        ...
        return HuggingFaceEmbeddings(show_progress=True, model_kwargs={"device": "cpu"}) #  changed torch_directml.device() to "cpu"
